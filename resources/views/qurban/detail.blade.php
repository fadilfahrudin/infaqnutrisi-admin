...
@section('title', 'Detail Transaksi Qurban')

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Detail Transaksi Qurban</h1>
...
<div class="row">
    <div class="col">
        <form id="form-update-donasi" action="{{ route('qurban.transaction.update', ['id' => $r->id]) }}" method="post">
            @csrf
            <input type="hidden" name="next-status" value="{{ $r->status == 'pending' ? 'done' : '' }}">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center">Informasi Transaksi<br><small>No. Pembayaran : {{ $r->transaction_code }}</small></h3>
                    <div class="row mt-5">
                        <div class="col">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-3 col-form-label">Nama Pemesan</label>
                        <div class="col-9">
                            <input type="text" class="form-control" value="{{ $r->customer_name }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-3 col-form-label">No. Telepon</label>
                        <div class="col-9">
                            <input type="text" class="form-control" value="{{ $r->customer_phone }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-3 col-form-label">E-Mail</label>
                        <div class="col-9">
                            <input type="text" class="form-control" value="{{ $r->customer_email }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="input-group">
                                ...
                                @php $amount = number_format($r->total_amount_final,0,',','.') @endphp
                ...
                <div class="card-footer">
                    <div class="row d-flex justify-content-between">
                        <a href="{{ route('qurban.transaction.index') }}" class="btn btn-outline-secondary justify-content-start">Kembali</a>
                        <div class="ml-auto">

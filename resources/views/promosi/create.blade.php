...
<div class="row">
    <div class="col">
        <form id="form-insert-berita" action="{{ route($route.'.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <select name="attribute1" id="attribute1" class="form-control" required>
                                ...
                                <option value="poster">Area Poster</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input type="text" class="form-control" name="attribute2" id="attribute2" required>
                        </div>
                    </div>
                    <div class="form-group row">
